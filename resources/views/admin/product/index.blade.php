                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($product->old_price && $product->old_price > $product->price)
                                                    <span class="text-muted" style="text-decoration: line-through;">${{ number_format($product->old_price, 2) }}</span><br>
                                                    <span class="text-success font-weight-bold">${{ number_format($product->price, 2) }}</span>
                                                    <small class="badge badge-success">{{ $product->discount_percentage }}% OFF</small>
                                                @else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger mt-3">
                        ...
                        <strong>This action cannot be undone!</strong> All data associated with this product will be permanently deleted.
                    </div>
                </div>
...
@foreach($products as $product)
    <div class="modal fade" id="statusModal{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel{{ $product->id }}" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-3">Are you sure you want to {{ $product->status == 1 ? 'deactivate' : 'activate' }} this product?</p>
