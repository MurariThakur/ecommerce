                        ...
                        <form action="{{ route('admin.product.update', $product) }}" method="POST">
                            ...
                            <div class="card-body">
                                                        ...
                                                        <div class="col-md-6 col-lg-4">
                                                            <div class="form-check mb-2">
                                                                <input class="form-check-input" type="checkbox" name="colors[]" value="{{ $key }}"
                                                                    id="color_{{ $key }}" {{ in_array($key, old('colors', $product->colors->pluck('id')->toArray() ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="brand_id" class="form-control @error('brand_id') is-invalid @enderror" id="brand_id">
                                        ...
                                        @foreach($brands as $key => $value)
                                            <option value="{{ $key }}" {{ old('brand_id', $product->brand_id) == $key ? 'selected' : '' }}>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('brand_id')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm float-right" id="add-size">Add Size</button>
                                        </div>
                                        <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote @error('description') is-invalid @enderror" id="description" name="description" rows="5">{{ old('description', $product->description) }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote @error('additional_information') is-invalid @enderror" id="additional_information" name="additional_information" rows="3">{{ old('additional_information', $product->additional_information) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote @error('shipping_return') is-invalid @enderror" id="shipping_return" name="shipping_return" rows="3">{{ old('shipping_return', $product->shipping_return) }}</textarea>
            ...
            if (categoryId) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        console.log('AJAX error in edit form:', xhr, status, error); // Debug log
