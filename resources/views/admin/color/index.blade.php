                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <form method="GET" action="{{ route('admin.color.index') }}" class="row g-3">
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" name="search"
                                            placeholder="Search by color name..." value="{{ request('search') }}">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-1">
                                        <div class="d-flex">
                                            ...
                                            @if (request()->hasAny(['search', 'status', 'date_from', 'date_to']))
                                                <a href="{{ route('admin.color.index') }}" class="btn btn-secondary ml-1">
