                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror"
                                        ...
                                        <option value="amount" {{ old('type', $discount->type) == 'amount' ? 'selected' : '' }}>Amount</option>
                                    </select>
                                    @error('type')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    <label for="amount_percentage">Amount/Percentage <span class="text-danger">*</span></label>
                                    <input type="number"
                                           step="0.01"
                                           min="0"
                                           class="form-control @error('amount_percentage') is-invalid @enderror"
                                           id="amount_percentage"
                                           name="amount_percentage"
                                           value="{{ old('amount_percentage', $discount->amount_percentage) }}"
                                           required>
                                    @error('amount_percentage')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date"
                                           ...
                                           id="expire_date"
                                           name="expire_date"
                                           value="{{ old('expire_date', $discount->expire_date->format('Y-m-d')) }}"
                                           required>
                                    @error('expire_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        ...
                                        <input type="checkbox"
                                               ...
                                               name="status"
                                               value="1"
                                               {{ old('status', $discount->status) ? 'checked' : '' }}>
