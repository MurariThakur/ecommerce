...
@foreach($discounts as $discount)
    <div class="modal fade" id="deleteModal{{ $discount->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel{{ $discount->id }}" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="card card-outline card-danger">
                        <div class="card-header"><h3 class="card-title">Discount Details</h3></div>
                        <div class="card-body">
                            <div class="row">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('admin.discount.destroy', $discount) }}" method="POST" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger"><i class="fas fa-trash"></i> Delete Discount</button>
                    </form>
                </div>
            </div>
        </div>
...
@foreach($discounts as $discount)
    <div class="modal fade" id="statusModal{{ $discount->id }}" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel{{ $discount->id }}" aria-hidden="true">
