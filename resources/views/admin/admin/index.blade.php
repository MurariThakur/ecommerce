                                                ...
                                                <div class="d-flex gap-1">
                                                    ...
                                                    @if($admin->id !== Auth::id())
                                                        <form action="{{ route('admin.toggle.status', $admin->id) }}"
                                                              method="POST" class="ml-1" style="display: inline-block;">
                                                            @csrf
                                                            <button type="submit"
                                                    ...
                                                    @else
                                                        <span class="btn btn-secondary btn-sm disabled ml-1" title="Cannot modify own account">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-warning mt-3">
                            ...
                            <strong>Warning:</strong> This action cannot be undone. All data associated with this admin will be permanently deleted.
                        </div>
                    </div>
