...
@section('content')
                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-search"></i> Search Brands</h3>
                            </div>
                            <div class="card-body">
                                <form method="GET" action="{{ route('admin.brand.index') }}" class="row g-3">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-1">
                                        <div class="d-flex">
                                            ...
                                            @if (request()->hasAny(['search', 'status', 'date_from', 'date_to']))
                                                <a href="{{ route('admin.brand.index') }}" class="btn btn-secondary ml-1">
                                                ...
                                                <td>
                                                    <div class="d-flex gap-1">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            <i
                                                                class="fas fa-{{ $brand->status == 1 ? 'ban' : 'check' }}"></i>
                                                        </button>
                    ...
                    <div class="modal-body">
                        ...
                        @if ($brand->products->count() > 0)
                            <div class="alert alert-warning">
                                ...
                                <strong>Warning:</strong> Deleting this brand will also delete
                                <strong>{{ $brand->products->count() }}</strong> associated product(s).
                            </div>
                        @endif
                        ...
                        @if ($brand->products->count() > 0)
                            <div class="card card-outline card-warning mt-3">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        <i class="fas fa-list"></i> Products to be Deleted
                        ...
                        <div class="alert alert-danger mt-3">
                            ...
                            <strong>This action cannot be undone!</strong> All data associated with this brand and its
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('admin.brand.destroy', $brand) }}" method="POST"
                            ...
                            <button type="submit" class="btn btn-danger">
                                <i class="fas fa-trash"></i>
                                Delete Brand @if ($brand->products->count() > 0)
    ...
    @foreach ($brands as $brand)
        <div class="modal fade" id="statusModal{{ $brand->id }}" tabindex="-1" role="dialog"
            aria-labelledby="statusModalLabel{{ $brand->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="mb-3">Are you sure you want to {{ $brand->status == 1 ? 'deactivate' : 'activate' }}
                            this brand?</p>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('admin.brand.toggle.status', $brand) }}" method="POST"
                            style="display: inline-block;">
                            @csrf
