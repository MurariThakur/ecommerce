...
@section('content')
                    ...
                    <div class="col-12">
                        ...
                        <div class="card mb-3">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-search"></i> Search Subcategories</h3>
                            </div>
                            <div class="card-body">
                                <form method="GET" action="{{ route('admin.subcategory.index') }}" class="row g-3">
                                    <div class="col-md-4">
                                    ...
                                    <tbody>
                                        @forelse($subcategories as $subcategory)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge badge-info">{{ $subcategory->category->name }}</span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-1">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            <i
                                                                class="fas fa-{{ $subcategory->status == 1 ? 'ban' : 'check' }}"></i>
                                                        </button>
                                ...
                                <div class="card-footer clearfix">
                                    ...
                                    <div class="float-left">
                                        <small class="text-muted">
                                            Showing {{ $subcategories->firstItem() ?? 0 }} to
    ...
    @foreach ($subcategories as $subcategory)
        <div class="modal fade" id="statusModal{{ $subcategory->id }}" tabindex="-1" role="dialog"
            aria-labelledby="statusModalLabel{{ $subcategory->id }}" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="statusModalLabel{{ $subcategory->id }}">
                            <i
                                class="fas fa-{{ $subcategory->status == 1 ? 'ban text-warning' : 'check text-success' }}"></i>
                    ...
                    <div class="modal-body">
                        <p class="mb-3">Are you sure you want to
                            {{ $subcategory->status == 1 ? 'deactivate' : 'activate' }} this subcategory?</p>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('admin.subcategory.toggle.status', $subcategory) }}" method="POST"
                            style="display: inline-block;">
                            @csrf
                            <button type="submit"
                                class="btn {{ $subcategory->status == 1 ? 'btn-warning' : 'btn-success' }}">
